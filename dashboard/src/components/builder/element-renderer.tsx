...
import type { PageElement, ButtonElement, CarouselElement, YoutubeElement, WhatsAppElement } from './types'
...
function WhatsAppRenderer({ whatsapp }: { whatsapp: WhatsAppElement }) {
